        ...
        <div class="card-body">
            ...
            <form action="{{ route('monhoc.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ma_mon" class="form-control" value="{{ old('ma_mon') }}" required>
                    @error('ma_mon')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ten_mon" class="form-control" value="{{ old('ten_mon') }}" required>
                    @error('ten_mon')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
